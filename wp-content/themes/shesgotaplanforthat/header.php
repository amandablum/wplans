...
el.innerHTML = '<button id="closexButton" onclick="document.getElementById(\'dabar\').style.display=\'none\'" >X</button> <div class="notification"><b>Welcome to Warren Plans!</b> To get started, choose a plan to read a summary. Then read questions submitted by the community. If your questions has not been answered, ask it. One of our moderators will find an answer. <i>This tool is a volunteer effort and is not associated with Elizabeth Warren for President.</i></div>'; // Add HTML code as you wish
